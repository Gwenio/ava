...
function parseTestArgs(args) {
	...
	const hookOptions = Array.isArray(args[0]) || typeof args[0] === 'function' ? {} : args.shift();
	...
	return {args, buildTitle, hookOptions, implementations, rawTitle, receivedImplementationArray};
}
